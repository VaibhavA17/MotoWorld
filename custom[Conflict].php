...
<html class="no-js"  lang="en">
	...
	<head>
		...
		<!-- TITLE OF SITE -->
		<title>Packages - Motoworld Tour N Travel</title>
        ...
        <div class="screen-body-item">
          <div class="app-form">
            ...
            <div class="app-form-group " > 
             ...
             <SELECT class="app-form-control" name="location1">
             	<OPTION >lOCATION 1</OPTION>
             	<OPTION>Leh Ladakh</OPTION>
             		<OPTION>Sarchu</OPTION>
            ...
            <div class="app-form-group  " >
             <SELECT class="app-form-control" name="location2">
             ...
             <div class="app-form-group " >
             <SELECT class="app-form-control" name="location3">
             ...
             <div class="app-form-group " >
             <SELECT class="app-form-control" name="location4" >
             	...
             	<OPTION>Leh Ladakh</OPTION>
                   ...
                   <div class="app-form-group">
              <input class="app-form-control" placeholder="Date" type="date" name="date">
            </div>

          <div class="app-form-group " >
             <SELECT class="app-form-control" name="transport">
            ...
            <div class="app-form-group">
             ...
             <div class="app-form-group">
              <input class="app-form-control" placeholder="Number of Members" name="number">
            </div>
            <div class="app-form-group">
...
$to         = "webpaagetech@gmail.com"; // where you want to get mail 
...
$message .= "<p>Location 1 :".$_POST['location1']."</p>";
$message .= "<p>Location 2 :".$_POST['location2']."</p>";
$message .= "<p>Location 3 :".$_POST['location3']."</p>";
$message .= "<p>Location 4 :".$_POST['location4']."</p>";
$message .= "<p>Number of Person :".$_POST['number']."</p>";
$message .= "<p>Preferred Transpost:".$_POST['transport']."</p>";
